...
int main()
{
        ...
        do
        {
                ...
                if(dado == 2)
                {
                    ...
                    while(manoJugador2SinCartasBloqueadas[cartaCorral - 1] == true){
                        ...
                        cout << "No puedes elegir la carta porque est� bloqueada por el contrario" << endl;
                ...
                if(dado == 6){
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        cout << "El jugador pas� de turno" << endl;
                        break;
                    default:
                        cout << "No se ingreso un n�mero v�lido" << endl;
                        break;
                    }
                }
    ...
    //ACA TERMINA LA OPCION ESTAD�STICAS
    ...
    //ACA TERMINA LA OPCION CR�DITOS
