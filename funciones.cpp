...
// Defino funcion para confirmar nombres de los jugadores
...
// Defino funci�n mezclar cartas tipo matriz
...
int tirardado()
{
    ...
    case 4:
        ...
        cout << "Intercambiar dos cartas del propio corral. Se eligen dos cartas del propio corral (1-5) y se intercambian entre s�"<<endl;
        break;
    case 5:
        cout << "LANZAMIENTO DADO #5" << endl;
        cout << "-------------------" << endl;

        cout << "Bloquear una carta del corral. La carta bloqueada no puede ser elegida por el contrario para intercambio (acciones 2 y 3) pero s� puede ser elegida por uno mismo."<<endl;
        break;
    case 6:
        ...
        break;
    default:
        cout << "Opci�n no v�lida. Arroje nuevamente el dado." << endl;
        break;
    }
    return dado;
}
